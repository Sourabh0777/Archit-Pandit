    ...
    <>
      <header
        className={`header top-0 left-0 z-40 flex w-full items-center ${
          sticky
            ? "dark:bg-gray-dark dark:shadow-sticky-dark shadow-sticky sticky top-0 bg-white/80 backdrop-blur-xs transition"
            : "shadow-sticky bg-transparent"
        }`}
      >
        <div className="container">
          <div className="relative -mx-2 flex items-center justify-between">
            <div className="w-60 max-w-full px-4 xl:mr-2">
              <Link
                href="/"
